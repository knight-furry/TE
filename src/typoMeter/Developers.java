...
public class Developers extends JFrame {
	...
	public Developers() {
		...
		typometer_title.setBounds(540, 160, 500, 40);
		...
		home_button.setBounds(160, 80, 100, 25);
		...
		datta.setBounds(260, 480, 170, 23);
		...
		katkhade.setBounds(228, 520, 240, 21);
		...
		datta_linkedin.setBounds(270, 558, 30, 35);
		datta_linkedin.setContentAreaFilled(false);
		datta_linkedin.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\linkedin_icon.png"));
		...
		datta_github.setBounds(333, 562, 30, 30);
		datta_github.setContentAreaFilled(false);
		datta_github.setBorder(null);
		datta_github.setFocusable(false);
		datta_github.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\github_icon.png"));
		...
		datta_instagram.setBounds(396, 558, 30, 30);
		datta_instagram.setContentAreaFilled(false);
		datta_instagram.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\instagram_icon.png"));
		...
		rituja.setBounds(555, 485, 180, 25);
		...
		puranik.setBounds(533, 525, 220, 25);
		...
		rituja_linkedin.setBounds(570, 558, 30, 35);
		rituja_linkedin.setContentAreaFilled(false);
		rituja_linkedin.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\linkedin_icon.png"));
		...
		rituja_github.setBounds(633, 562, 30, 30);
		rituja_github.setContentAreaFilled(false);
		rituja_github.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\github_icon.png"));
		...
		rituja_instagram.setBounds(696, 558, 30, 30);
		rituja_instagram.setContentAreaFilled(false);
		rituja_instagram.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\instagram_icon.png"));
		...
		pranavi.setBounds(820, 485, 230, 23);
		...
		pranavi_linkedin.setBounds(860, 558, 30, 35);
		pranavi_linkedin.setContentAreaFilled(false);
		pranavi_linkedin.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\linkedin_icon.png"));
		...
		pranavi_github.setBounds(923, 562, 30, 30);
		pranavi_github.setContentAreaFilled(false);
		pranavi_github.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\github_icon.png"));
		...
		pranavi_instagram.setBounds(985, 558, 30, 30);
		pranavi_instagram.setContentAreaFilled(false);
		pranavi_instagram.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\instagram_icon.png"));
		...
		shivam.setBounds(1140, 485, 190, 22);
		...
		bhawar.setBounds(1128, 525, 210, 21);
		...
		shivam_linkedin.setBounds(1150, 558, 30, 35);
		shivam_linkedin.setContentAreaFilled(false);
		shivam_linkedin.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\linkedin_icon.png"));
		...
		shivam_github.setBounds(1217, 562, 30, 30);
		shivam_github.setContentAreaFilled(false);
		shivam_github.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\github_icon.png"));
		...
		shivam_instagram.setBounds(1286, 558, 30, 30);
		shivam_instagram.setContentAreaFilled(false);
		shivam_instagram.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\instagram_icon.png"));
		...
		background_picture.setBounds(150, 70, 1281, 658);
