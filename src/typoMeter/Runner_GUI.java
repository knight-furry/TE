...
public class Runner_GUI
{
	...
	private void initialize(TypingSample sample)
	{
		...
		input_field.setBounds(514, 440, 460, 100);
		...
		home_button.setBounds(520, 590, 100, 25);
		...
		back_button.setBounds(640, 590, 100, 25);
		...
		submit_button.setBounds(758, 590, 100, 25);
		...
		exit_button.setBounds(1045, 236, 30, 30);
		...
		refresh_button.setBounds(1045, 319, 30, 30);
		refresh_button.setContentAreaFilled(false);
		refresh_button.setIcon(new ImageIcon("C:\\Users\\Datta\\eclipse-workspace\\datta\\TypoMeter-2.1\\Pictures\\refresh_button.png"));
		...
		result_board.setBounds(1130, 160, 300, 200);
		...
		username.setFont(new Font("Broadway", Font.PLAIN, 23));
		...
		record_button.setBounds(1130, 365, 300, 25);
		frame.getContentPane().add(record_button);
		
		JScrollPane record_table = new JScrollPane();
		record_table.setEnabled(false);
		record_table.setToolTipText("");
		record_table.setFont(new Font("Segoe UI Symbol", Font.PLAIN, 15));
		...
		record_table.setBounds(1130, 390, 300, 270);
		...
		table_record.setGridColor(new Color(204, 0, 0));
		...
		input_field.addKeyListener(new KeyAdapter()
		{
			...
			public void keyReleased(KeyEvent e)
			{
				...
				if (input_field.getText().length() >= sample.getCharacterCount())
				{
					...
					wpm_out = (String.format("%.1f WPM", wordsPerMin));
