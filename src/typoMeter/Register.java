...
public class Register extends JFrame {
	...
	public Register() {
		...
		peephole_frame.setBounds(690, 40, 210, 260);
		...
		first_name_title.setBounds(480, 290, 300, 35);
		...
		first_name.setBounds(480, 330, 250, 30);
		...
		last_name_title.setBounds(810, 290, 300, 35);
		...
		last_name.setBounds(810, 330, 250, 30);
		...
		email_id_title.setBounds(810, 370, 300, 35);
		...
		email_id.setBounds(810, 410, 250, 30);
		...
		username_title.setBounds(480, 370, 300, 35);
		...
		username.setBounds(480, 410, 250, 30);
		...
		password_title.setBounds(480, 450, 300, 35);
		...
		password.setBounds(480, 490, 250, 30);
		...
		confirm_password_title.setBounds(810, 450, 300, 35);
		...
		confirm_password.setBounds(810, 490, 250, 30);
		...
		reset_button.setBounds(480, 560, 75, 30);
		...
		register_button.setBounds(695, 560, 150, 30);
		...
		register_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				else
				{
					...
					try
					{
			            String query = "insert into UserData(First_Name, Last_Name, Email_ID, Username, UserPassword, Confirm_Password) values (?, ?, ?, ?, ?, ?);";
			            ...
			            st.executeUpdate();
			            JOptionPane.showMessageDialog(null, "Could Your Registration Be Any More Successful?");
		...
		exit_button.setBounds(985, 560, 75, 30);
