...
public class Option_Menu {
	...
	private void initialize() {
		...
		menu_board_title.setBounds(631, 155, 282, 143);
		...
		choose_option_title.setBounds(660, 330, 250, 30);
		frame.getContentPane().add(choose_option_title);
		
		JRadioButton radio_button1 = new JRadioButton("The One with the Tea Leaves");
		radio_button1.setContentAreaFilled(false);
		radio_button1.setForeground(new Color(0, 255, 255));
		...
		radio_button1.setMaximumSize(new Dimension(500, 25));
		radio_button1.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		radio_button1.setBounds(631, 410, 282, 50);
		...
		radio_button2.setContentAreaFilled(false);
		radio_button2.setForeground(new Color(255, 153, 255));
		...
		radio_button2.setBounds(631, 480, 282, 50);
		...
		radio_button3.setContentAreaFilled(false);
		...
		radio_button3.setBounds(631, 550, 282, 50);
		...
		menu_board.setBounds(600, 0, 350, 733);
